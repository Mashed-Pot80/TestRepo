...
def get_scatter_chart(entered_site,sliderval):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.scatter(x=data['Payload Mass (kg)'], y=data['class'], 
            color=data['Booster Version Category'],
            title='Correlation between Payload and Success for Launch Site '+str(entered_site))
        return fig
